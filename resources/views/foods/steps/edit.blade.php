...
@section('content')
    <div class="page">
        <div class="page-header">
            <h1 class="page-title">Editing step for {{ $food->name }}</h1>
            <ol class="breadcrumb">
        ...
        <div class="page-content">
            ...
            <div class="panel">
                ...
                <div class="panel-body container-fluid">
                    <form method="POST" action="{{ route('foods.steps.update', ['food' => $food->id, 'step' => $step->id]) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PATCH')
                        ...
                        @elseif($step->image)
                            <img src="{{ \Illuminate\Support\Facades\Storage::url('food-steps/'.$step->image) }}" alt="" style="max-width: 300px;max-height: 300px;">
                        @endif
                        @if ($errors->any())

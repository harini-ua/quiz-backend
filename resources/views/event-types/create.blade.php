        ...
        <div class="page-content">
            ...
            <div class="panel">
                ...
                <div class="panel-body container-fluid">
                    <form method="POST" action="{{ route('event-types.store') }}" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="col-md-6 col-lg-6">
                                <div class="example-wrap">
                                    ...
                                    <input type="text" class="form-control" id="inputPlaceholder"
                                           placeholder="example: Dinner for two" name="title">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row row-lg">
                            <div class="col-md-6 col-lg-6">
                                <div class="example-wrap">
                                    ...
                                    <input type="text" class="form-control" id="inputPlaceholder"
                                           placeholder="example: Dinner for two" name="title_spanish">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row row-lg">
                            <div class="col-md-6 col-lg-6">
                                <div class="example-wrap">
                                    ...
                                    <input type="text" class="form-control" id="inputPlaceholder"
                                           placeholder="example: Dinner for two" name="title_german">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="slider-wrap">
                                <div class="slider__slide">
                                    ...
                                    <div class="slider__slide-text-wrap">
                                        <h2 class="slider__slide-title" id="title_preview"></h2>
                                        <span class="slider__slide-text" id="description_preview"></span>
                                    </div>
                                </div>
                            </div>
                        </div>
